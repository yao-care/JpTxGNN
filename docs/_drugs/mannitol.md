...
| 予測新適応症 | 腎源性抗利尿不當症候群、惡性高熱、家族性週期性麻痺、低血鉀週期性麻痺、腎源性尿崩症、King-Denborough 症候群等 |
| TxGNN 予測スコア | 0.997-0.999 |
| エビデンスレベル | **L3** (低血鉀週期性麻痺)、**L5** (其他 - 僅預測或文獻薄弱) |
| 臨床試驗 | 無直接相關 |
| PubMed 文獻 | 部分有 |
...
| 預測適應症 | 預測可信度 | 機轉合理性 | エビデンスレベル | 建議優先度 |
|-----------|-----------|-----------|---------|-----------|
